...
class PlaceholderSprites:
    ...
    @staticmethod
    def create_ninja_idle(width: int = 56, height: int = 84, frame: int = 0) -> pygame.Surface:
    ...
    @staticmethod
    def create_ninja_slide(width: int = 56, height: int = 50, frame: int = 0) -> pygame.Surface:
    ...
    @staticmethod
    def create_ninja_jump(width: int = 56, height: int = 84, frame: int = 0, is_double_jump: bool = False) -> pygame. Surface:
        sprite = PlaceholderSprites._get_real_sprite('jump', frame, width, height)
        return sprite if sprite else PlaceholderSprites._create_fallback(width, height)

    @staticmethod
    def create_ninja_attack(width: int = 70, height: int = 84, frame: int = 0) -> pygame.Surface:
        sprite = PlaceholderSprites._get_real_sprite('attack', frame, width, height)
        return sprite if sprite else PlaceholderSprites._create_fallback(width, height)

    @staticmethod
    def create_ninja_dash(width: int = 56, height: int = 84, frame: int = 0) -> pygame.Surface:
    ...
    @staticmethod
    def create_obstacle_barrier(width: int = 56, height: int = 100) -> pygame.Surface:
        surf = pygame.Surface((width, height), pygame.SRCALPHA)
        pygame.draw.rect(surf, (100, 60, 40), (10, 0, width-20, height))
        return surf

    @staticmethod
    def create_breakable_crate(width: int = 56, height: int = 70) -> pygame.Surface:
        surf = pygame.Surface((width, height), pygame.SRCALPHA)
